...
Set Picture = LoadPicture(APPROOT + "\ARTBAS\PICS_RUNTIME\SCREEN_05.JPG")
...
frmASSO.Caption = monthtab(current_month) + " " + _
                    Format(current_year, "0000") + " - " + msgtab(44)
                    
lblSTRATA.Caption = msgtab(42): lblSITES.Caption = msgtab(43)
...
Printer.Print Tab(5); frmASSO.Caption
